    ...
    switch (type) {
      ...
      case "order":
        data = {
          ...
          icon: <ShoppingCartOutlinedIcon class="flex self-end h-5 bg-blue-400 rounded-md" />,
        };
        break;
      case "earning":
        data = {
          ...
          icon: <MonetizationOnOutlinedIcon class="flex self-end h-5 rounded-md bg-green-400" />,
        };
        break;
      case "balance":
        data = {
          ...
          icon: <AccountBalanceWalletOutlinedIcon class="flex self-end h-5 rounded-md bg-orange-300" />,
        };
        break;
